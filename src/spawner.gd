...
@onready var base_item_spawn_table = [[preload("res://src/items/slingshot.tscn"), 5], [preload("res://src/items/shiv.tscn"), 15], [preload("res://src/items/preserved_insect.tscn"), 2],
...
@onready var chest_item_spawn_table = [[preload("res://src/items/slingshot.tscn"), 10], [preload("res://src/items/wooden_shield.tscn"), 10], [preload("res://src/items/preserved_insect.tscn"), 766], 
